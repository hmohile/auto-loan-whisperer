...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background font-['Inter',_system-ui,_sans-serif] overflow-x-hidden">
      ...
      <section className="relative py-20 sm:py-24 lg:py-32 bg-gradient-hero overflow-hidden">
        <div className="section-container">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Hero Content */}
            <div className="space-y-8 animate-fade-in-up">
              <div className="space-y-6">
                <Badge variant="secondary" className="bg-emerald-50 text-primary border-primary/20 px-4 py-2 font-medium animate-scale-in">
                  <Verified className="h-4 w-4 mr-2" />
                  Trusted by 10,000+ borrowers
                </Badge>
                
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight text-slate-900 tracking-tight animate-delay-200">
                  Auto Loans.{" "}
                ...
                <p className="text-xl sm:text-2xl text-slate-600 leading-relaxed max-w-2xl animate-delay-300">
              ...
              {/* Hero CTAs */}
              <div className="flex flex-col sm:flex-row gap-4 pt-4 animate-delay-400">
                <Link to="/auth">
                  <Button 
                    size="lg" 
              ...
              {/* Trust Indicators */}
              <div className="flex flex-wrap items-center gap-6 pt-4 text-sm text-slate-500 animate-delay-500">
            ...
            <div className="flex justify-center lg:justify-end animate-float">
              <div className="relative max-w-lg w-full">
                <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-primary/10 blur-3xl transform rotate-6 animate-pulse"></div>
                <div className="relative bg-white p-8 rounded-3xl shadow-2xl border border-primary/10 hover:shadow-3xl transition-shadow duration-500">
                  ...
                  />
                  <div className="absolute -bottom-4 -right-4 bg-gradient-to-r from-primary to-primary/90 text-white px-4 py-2 rounded-xl text-sm font-semibold shadow-lg animate-bounce">
                    Live Demo →
                  </div>
                </div>
              </div>
      ...
      <section id="features" className="py-24 bg-gradient-subtle">
        <div className="section-container">
          <div className="text-center mb-20 space-y-6">
            <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 animate-fade-in-up">
              Why Choose Qualifi AI?
            </h2>
            <p className="text-xl sm:text-2xl text-slate-600 max-w-4xl mx-auto leading-relaxed animate-fade-in-up animate-delay-200">
      ...
      <section id="ai-copilot" className="py-24 bg-gradient-subtle">
        <div className="section-container">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={index} className="flex items-start space-x-3 animate-slide-in-left" style={{ animationDelay: `${index * 100}ms` }}>
      ...
      <section className="py-24 bg-white">
        <div className="section-container max-w-6xl">
          ...
          <Card className="overflow-hidden shadow-2xl border-0 card-premium">
        ...
        <div className="section-container">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              <Card key={index} className="card-interactive text-center p-8">
      ...
      <section id="waitlist" className="py-24 bg-gradient-to-br from-primary to-primary/90 text-white relative overflow-hidden">
        ...
        <div className="section-container max-w-6xl text-center relative z-10">
          <div className="flex items-center justify-center mb-8">
            <div className="w-20 h-20 bg-white/20 rounded-2xl flex items-center justify-center animate-pulse-glow">
